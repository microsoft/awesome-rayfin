...
import type { ApiKeyAppSchema } from '../../rayfin/data/schema';
...
export function initRayfinClient(
  ...
  client = new RayfinClient<ApiKeyAppSchema>({
...
export function getRayfinClient(): RayfinClient<ApiKeyAppSchema> {
  if (!client) {
    throw new Error(
