...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype.downloadScript = function() {
      ...
      return new Dosbox.Xhr('/jsdos/js-dos-v3.js', {
        success: (function(_this) {
    ...
    Dosbox.prototype._jsdos_init = function(module, script, onload) {
      ...
      Module = module;
      eval(script);
      // Expose the Emscripten filesystem on the module so the host app can
      // read/write DOOM's save files (FS is otherwise trapped in this scope).
      try { module.FS = FS; } catch (e) {}
      if (onload) {
        return onload(this);
      }
    };
