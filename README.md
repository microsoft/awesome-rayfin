...
| **[Finance Analytics](./templates/finance-analytics)** | Config-driven FP&A app for Microsoft Fabric — variance/trend/aging tables with native Excel copy, accessible charts, filters + cross-filter, a deterministic intelligence rail, and PowerPoint/Excel/CSV export. Runs offline on sample data or against a live semantic model. | ✅ | — | React, Vite, Tailwind |
...
| **[Semantic Directory](./templates/semantic-directory)** | A live, searchable directory for any Power BI or Fabric semantic model — search measures and fields, trace lineage and relationships, inspect measure DNA and change impact, and explore a bundled demo model with zero setup. | ✅ | — | React, Vite, Tailwind |
