...
| **[Helsinki Public Transport](./templates/helsinki-public-transport)** | Live public transport over a Fabric Real-Time Intelligence Eventhouse - a DirectQuery semantic model queried straight from the browser, drawn on a 2D map and on a token-free photoreal 3D city twin built from open geodata | ✅ | — | React, Vite, Tailwind |
