...
| **[Maritime Insights](./templates/maritime-insights)** | Interactive 3D coastal twin of the Kiel Fjord, built entirely from open geodata — true-scale DGM1 terrain with LoD2 buildings and an orthophoto drape, a coarse Copernicus DEM shell for the horizon, and a geometric sensor-visibility model that is explicitly not a radar model. | ✅ | — | React, Vite |
