...
### 1. Auto-generate `rayfin-template.yml` from `templates/` directories
...
### 2. CI workflow: validate manifest + scaffold test
...
### 4. Template-for-templates (scaffolding a new template contribution)
...
### 5. Template style/structure guidelines doc
...
### 6. Copilot skills for template creation/validation
...
### 11. Root-level `AGENTS.md` / `.mcp.json` cleanup
...
### 12. README table auto-generation
